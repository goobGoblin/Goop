...
\begin{table}[h!]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|l|l|l|}
            ...
            & Initialized React App and outlined component design & 2 hours \\ \hline
            & Experimented with webscraping for various sites & 5 hours \\ \hline
            & Manually created JSON files for genres and subgenres & 4 hours \\ \hline
            & Implemented data cleaner to put JSON genre files into DB & 1 hour \\ \hline
            & Attempted to implement 1001 tracklists scraper & 3 hours \\ \hline
            & Updated styling & 2 hours \\ \hline
            & Modified database to make reference tables for foreign keys & 30 minutes \\ \hline
            & Implemented resident advisor scraper and data cleaner & 6+ hours \\ \hline
            & Updated backend and created references to display the front end according to filters on the page & \\ \hline
        \end{tabular}
    }
